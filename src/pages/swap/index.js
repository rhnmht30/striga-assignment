      ...
      <section>
        <div className="max-w-7xl xl:mx-auto px-6 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-[1fr_48px_1fr] gap-8 mt-8">
            <div className="flex flex-col space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  >
                    Available balance: {coinsMeta['EUR'].symbol}
                    {Number(
                      Number(accounts['EUR'].availableBalance.amount) /
                        Math.pow(10, coinsMeta['EUR'].decimals),
                    ).toFixed(coinsMeta['EUR'].decimals)}
                  </p>
                </div>
                <div className="relative mt-2 rounded-md shadow-sm">
                  <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                    <span className="text-gray-500 dark:text-gray-400 sm:text-sm">
                      {coinsMeta['EUR'].symbol}
                    </span>
                  </div>
                  <input
                    type="text"
                  ...
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                    <span
                      ...
                      id="price-currency"
                    >
                      {accounts['EUR'].availableBalance.currency}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between">
                  ...
                  >
                    Available balance: {coinsMeta['BNB'].symbol}
                    {Number(
                      Number(accounts['BNB'].availableBalance.amount) /
                        Math.pow(10, coinsMeta['BNB'].decimals),
                    ).toFixed(coinsMeta['BNB'].decimals)}
                  </p>
                </div>
                ...
                <div className="relative mt-2 rounded-md shadow-sm">
                  ...
                  <div className="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                    <span
                      ...
                      id="price-currency"
                    >
                      {accounts['BNB'].availableBalance.currency}
                    </span>
                  </div>
                </div>
              </div>
            ...
            <button className="mt-8 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-600">
              ...
              <dl className="-my-3 divide-y divide-gray-100 dark:divide-gray-50/25 px-6 py-4 text-sm leading-6">
                <div className="flex justify-between gap-x-4 py-3">
                  ...
                  <dd className="flex items-center text-gray-900 dark:text-white">
                    {accounts['EUR'].accountId.slice(0, 6)}
                    <ClipboardDocumentIcon
            ...
            <button className="sm:mt-8 overflow-hidden rounded-xl border border-gray-200 dark:border-gray-600">
              <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 dark:bg-gray-800 p-6">
                <div className="block h-12 w-12 rounded-lg p-2 ring-1 ring-gray-900/10 dark:ring-gray-50/25">
                  {coinsMeta['BTC'].icon}
                </div>
                <div className="text-sm font-medium leading-6 text-gray-900 dark:text-white">
                  {accounts['BTC'].currency}
                </div>
              </div>
              <dl className="-my-3 divide-y divide-gray-100 dark:divide-gray-50/25 px-6 py-4 text-sm leading-6">
                <div className="flex justify-between gap-x-4 py-3">
                ...
                <div className="flex justify-between gap-x-4 py-3">
                  ...
                  <dd className="flex items-center text-gray-900 dark:text-white">
                    {accounts['BTC'].accountId.slice(0, 6)}
                    <ClipboardDocumentIcon
                      className="block h-5 w-5 ml-3 text-gray-800 dark:text-gray-100"
                      aria-hidden="true"
                    />
            ...
            <button className="mt-8 overflow-hidden rounded-xl border border-dashed border-gray-200 dark:border-gray-600">
              <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 dark:bg-gray-800 p-6">
              ...
              <dl className="-my-3 divide-y divide-gray-100 divide-dashed dark:divide-gray-50/25 px-6 py-4 text-sm leading-6">
                <div className="flex justify-between gap-x-4 py-3">
                  <dt className="text-gray-500 dark:text-gray-400">
                    Wallet ID
                  </dt>
            ...
            <button className="sm:mt-8 overflow-hidden rounded-xl border border-dashed border-gray-200 dark:border-gray-600">
              <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 dark:bg-gray-800 p-6">
                <div className="flex h-12 w-12 rounded-lg p-1 ring-1 ring-gray-900/10 dark:ring-gray-50/25 items-center justify-center">
                  <div className="bg-gray-100 dark:bg-gray-700/25 h-full w-full flex rounded-lg" />
                </div>
